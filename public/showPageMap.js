...
for(let j = 0; j < flightroutesCopy.length; j++){
    ...
    oriGeo = flightroutesCopy[j].oriGeometry.coordinates;
    desGeo = flightroutesCopy[j].desGeometry.coordinates; 
    ...
    map.on('load', function () {
        ...
        window['animate'+ count] = () => {
            ...
            if (window['counter' + count] < steps) {
                requestAnimationFrame(window['animate'+ count]);
            }
        ...
        document
            .getElementById('flight' + count + '')
            .addEventListener('click', function () {
                // Set the coordinates of the original point back to origin
                window['point' + count].features[0].geometry.coordinates = oriGeo;
                ...
                window['animate'+ count](window['counter' + count]);
            });
    });
